...
async function save(req, res) {
    try {
        const response = await formService.save_form(req.body)
        if (response) {
            return res
...
async function get_all_users(req, res) {
    try {
        const response = await formService.form_get_all_users()
        if (response) {
            return res
                .status(response.statusCode)
                .json(response);
...
async function get_user_by(req, res) {
    try {
        const response = await formService.form_get_user_by(req.query)
        if (response) {
            return res
                .status(response.statusCode)
                .json(response);
